...
class RFDB(nn.Module):
    def __init__(self, in_channels, distillation_rate=0.25):
        ...
        self.c1_r1 = conv_layer(in_channels*3, self.rc, 1)
    ...
    def forward(self, input):
        ...
        swinT = self.swinT(input)
        swinT2= self.swinT2(input)
        swinT3 = self.swinT3(input)
        out_B = self.c1_r1(torch.cat([swinT, swinT2, swinT3], dim=1))
        out_fused = self.esa(self.c1_r(out_B))
        return out_fused
